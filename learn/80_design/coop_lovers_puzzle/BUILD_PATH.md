...
1. Do the existing co-op lesson first — it is literally your Milestone 1-3:
   ...
   - runnable answer: `learn/95_solutions/co_op/different_views_puzzle/prototype/`
...
2. Read the migration checklist: `learn/templates/SAUCE_MIGRATION_TICKETS.md` (Co-op section).
3. In `sauce/`:
...
1. **Prototype the fun** in the existing `learn/70_co_op/` lesson + your milestones.
