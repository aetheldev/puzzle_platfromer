...
1. Start from `learn/30_fundamentals/t07_tilemap`
...
`learn/70_co_op/different_views_puzzle/prototype`

Runnable answer lives in:

`learn/95_solutions/co_op/different_views_puzzle/prototype`
