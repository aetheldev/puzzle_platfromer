...
Two**, **Keep Talking and Nobody Explodes**. See `learn/RESOURCES.md` section 4.
...
- This is EXACTLY what the repo's existing co-op prototype teaches. You already
  have a starting point: `learn/co_op/different_views_puzzle/`.
...
Stop after Milestone 5 for your first finished thing. Everything past it is polish.
...
See `learn/design/coop_lovers_puzzle/BUILD_PATH.md` for two concrete paths:
...
2. Do the co-op prototype lesson: `learn/co_op/different_views_puzzle/prototype/`.
