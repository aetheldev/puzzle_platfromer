...
TASKS FOR YOU:
  [x] Run it: WASD/arrows to move, SPACE to jump.
  [x] Edit the LEVEL string below to build a different layout.
  [x] Add a new tile type (2 = spike, kills the player — reset position).
  [x] Count and print how many solid tiles are in the level.
*/
