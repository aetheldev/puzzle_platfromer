...
Open:
- `learn/solutions/odin_for_js_devs/o16_debugging_and_printing/main.odin`
...
**Next step:** `learn/game_thinking_for_web_devs/` (coming soon)
or jump directly to `learn/fundamentals/t01_hello_window`
