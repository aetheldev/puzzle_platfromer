...
The game lessons in `learn/fundamentals/` use Odin code that looks foreign if you have never seen:
- `::` vs `:=` vs `=`
...
- `learn/solutions/odin_for_js_devs/`

## After This Track

When you finish o16, move to:
- `learn/game_thinking_for_web_devs/` (coming soon)
- Then `learn/fundamentals/t01_hello_window`
